...
import com.shaimaziyad.khayal1.repository.NovelRepository
...
//        list.add(Banner("1","Ad number one","hi this is sub title","welcome this is description", R.drawable.ad_one)) // banner type one
        ...
        categories?.forEach { category ->
            ...
            Log.d(TAG, "category:${getNovelCategoryKey(context, category.toInt())}")
            list.add(NovelData(getNovelCategoryKey(context, category.toInt()), filteredNovels))
        }
